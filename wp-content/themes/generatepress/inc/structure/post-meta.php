    ...
    if ('categories' === $item) {
        ...
        if ($categories_list && $categories) {
            echo apply_filters(
                ...
                sprintf(
                    '<span class="cat-links">%3$s<span class="screen-reader-text">%1$s </span>%2$s</span> ', // WPCS: XSS ok, sanitization ok.
    ...
    if ('tags' === $item) {
        ...
        if ($tags_list && $tags) {
            echo apply_filters(
                ...
                sprintf(
                    '<span class="tags-links">%3$s<span class="screen-reader-text">%1$s </span>%2$s</span> ', // WPCS: XSS ok, sanitization ok.
...
if (! function_exists('generate_excerpt_more')) {
    ...
    {
        return apply_filters('generate_excerpt_more_output', sprintf(
...
if (! function_exists('generate_content_more')) {
    ...
    {
        return apply_filters('generate_content_more_link_output', sprintf(
