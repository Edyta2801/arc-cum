    ...
    class LazyBlocks {
        ...
        public function admin_enqueue_scripts() {
            ...
            if ( 'lazyblocks' === $post_type ) {
                ...
                wp_enqueue_style( 'lazyblocks-constructor', $this->plugin_url() . 'assets/admin/constructor/style.min.css', array(), '2.0.7' );
            }
            ...
            wp_enqueue_style( 'lazyblocks-admin', $this->plugin_url() . 'assets/admin/css/style.min.css', '', '2.0.7' );
        }
    }
